    ...
    <div className="mx-auto max-w-2xl px-4">
      <div className="rounded-lg border bg-background p-8">
        ...
        <p className="leading-normal text-muted-foreground">
          This is going to take about 20 minutes and by the time we're done,
          you'll have some clear ideas about your personal brand as well as an
          action plan to implent it! Let's start by you telling me the story of
          you - just write down what ever comes to mind, long or short and I'll
          guide you through the process until I have enough to go on...
        </p>
